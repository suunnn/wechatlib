...
use WeChatLib\Kernel\Exceptions\RuntimeException;
use WeChatLib\Kernel\Support\Pkcs7;
use WeChatLib\Kernel\Support\Str;
...
class Encryptor
{
     ...
     * @throws \Exception
     */
    public function encrypt(string $plaintext, $nonce = null, $timestamp = null): string
    {
        try {
